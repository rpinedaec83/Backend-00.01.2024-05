...
let filtro={ year: 2030};
// crud('sample_mflix','movies','leerUno',filtro).then((res) => {
//     console.log(res)
// });

// crud('sample_mflix','movies','leerTodos',filtro).then((res) => {
//     console.log(res)
// });
let data = {
...
// crud('sample_mflix','movies','agregarUno',filtro, data).then((res) => {
//     console.log(res)
// });
...
// crud('sample_mflix','movies','agregarVarios',filtro, data1).then((res) => {
//     console.log(res)
// });

let filtro1 = { title: "Four Sons" }
let data2 = { $set: { year: 1925 } }
// crud('sample_mflix','movies','leerTodos',filtro1).then((res) => {
//     console.log(res)
// });
// crud("sample_mflix", "movies", "actualizarVarios", filtro1, data2).then((res) => {
//     console.log(res)
// });

// crud("sample_mflix", "movies", "borrarUno", filtro1, data2).then((res) => {
//     console.log(res)
// });

crud("sample_mflix", "movies", "borrarVarios", filtro1, data2).then((res) => {
    console.log(res)
});